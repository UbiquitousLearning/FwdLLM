...
import sys
import os
print(os.path.abspath(sys.modules[transformers.__module__].__file__))
...
def add_centralized_args(parser):
    ...
    parser.add_argument('--forward_mode', default=False, action="store_true",
                        help='use forward gradient')

    parser.add_argument('--v_num', type=int, default=1, metavar='N',
                        help='v_num')
    return parser
