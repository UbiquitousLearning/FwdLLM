...
parser.add_argument('--partition_file', type=str, default='/data/wyz/fednlp_data/partition_files/agnews_partition.h5',
                        metavar="PF", help='data partition path')
parser.add_argument('--data_file', type=str, default='/data/wyz/fednlp_data/data_files/agnews_data.h5',
...
parser.add_argument('--task_type', type=str, default='text_classification',metavar="TT", help="task type")
