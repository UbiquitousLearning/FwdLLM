...
class SpanExtractionTrainer:
    ...
    def train_model(self, device=None):
        ...
        for epoch in range(0, args.epochs):
            # index_list = random.sample(range(0,len(self.train_dl)),20)
    ...
    def eval_model(self, epoch=0, global_step=0, device=None):
        ...
        logging.info("calculate_results")
        ...
        logging.info("write")
        with open("/home/wuyaozong/experiment_data/fednlp_bert/{}_{}_lr={}_freeze={}_quantize={}_adapter={}.txt".format(self.args.dataset,self.args.partition_method,self.args.learning_rate,self.args.freeze_layers,self.args.use_quantize,self.args.use_adapter), "a") as f:
